namespace _06._Heap
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (queue.Count > 0)
            {
                Console.WriteLine(queue.Dequeue()); //out: 환자1 - 감기, 환자2 - 타박상, 환자3 - 심장마비 
            }
            ...
            {
                Console.WriteLine(priorityQueue.Dequeue());//out: 환자3 - 심장마비,환자4 - 교통사고,환자1 - 감기
            }
            ...
            {
                Console.WriteLine(priorityQueue.Dequeue());//out: 환자3 - 심장마비, 환자2 - 타박상												
